          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr,index) in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" @click="changeActive(spuSaleAttrValue,spuSaleAttr.spuSaleAttrValueList)" :class="{active:spuSaleAttrValue.isChecked==1}" v-for="(spuSaleAttrValue,index) in spuSaleAttr.spuSaleAttrValueList" :key="spuSaleAttrValue.id">{{spuSaleAttrValue.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
                ...
                <a href="javascript:" class="mins" @click="skuNum<2?skuNum==1:skuNum--">-</a>
              </div>
              <div class="add">
  ...
  export default {
    ...
    async addShopcar(){
      ...
      try {
        ...
        // 在路由跳转的时候也需要把所选产品的信息带给所跳转的路由
        // 一些简单的数据比如skuNum，可以通过query形式传给路由组件
        this.$router.push({name:'addcartsuccess',query:{skuNum:this.skuNum}})
        // 复杂的数据比如skuInfo，使用会话存储
